...
const useHttp = (applyData) => {
  ...
  // but requestConfig and applyData are functions
  // we can move the first one as argument in sendRequest(-> not external anymore!)
  // and we manage (useCallback) the second one in app.js
