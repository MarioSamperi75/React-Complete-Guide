...
const ProfileForm = () => {
  ...
  const submitHandler = (event) => {
    ...
    fetch(
      "https://identitytoolkit.googleapis.com/v1/accounts:update?key=AIzaSyA3zOxsuKzbaaDE0gwN_CRlSBAQgYy_BFs",
      {
        method: "POST",
        body: JSON.stringify({
      ...
      // in this case to keep it easy
      // we add the attribute minLength in the component
